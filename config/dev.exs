...
config :gameplatform, GameplatformWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "KpPspaZgRmXg9MY/LUv3wVxCnt5nMzxuKgLgJXrbzzsDyVJKsgBJJKMgToijc1FS",
  watchers: [
...
config :gameplatform, GameplatformWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/gameplatform_web/(live|views)/.*(ex)$",
      ~r"lib/gameplatform_web/templates/.*(eex)$"
    ]
  ]
